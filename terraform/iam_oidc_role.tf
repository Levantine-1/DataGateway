...
data "aws_iam_policy_document" "github_actions_assume_role" {
  statement {
    ...
    condition {
      ...
      #   repo:Levantine-1@71067517/DataGateway@1342417979:ref:refs/heads/master
      # instead of the classic
      #   repo:Levantine-1/DataGateway:ref:refs/heads/master
      ...
      # only the numeric IDs, anchored after "Levantine-1@" and "/DataGateway@".
      test     = "StringLike"
...
resource "aws_iam_role" "github_actions_datagateway" {
  name               = "github_actions_datagateway"
  assume_role_policy = data.aws_iam_policy_document.github_actions_assume_role.json
}

# ecr/ec2/route53 statements mirror the core repo's terraform/iam/policies/
# terraform_datagateway_policy.tf (granted to the old static-key IAM user)
# -- kept self-contained here rather than referencing that module, since
# the point of this migration is per-repo terraform ownership. The s3
...
resource "aws_iam_role_policy" "github_actions_datagateway_policy" {
  name = "github_actions_datagateway_policy"
  role = aws_iam_role.github_actions_datagateway.id
    ...
    "Statement": [
        {
            ...
            "Resource": "arn:aws:iam::975050308029:role/github_actions_datagateway"
        },
        {
            "Effect": "Allow",
            "Action": [
            ...
            "Resource": "arn:aws:ecr:${var.region}:975050308029:repository/datagateway"
        },
        {
            "Effect": "Allow",
            "Action": [
        ...
        },
        {
            ...
            "Resource": "arn:aws:s3:::prod-levantine-terraform-bucket/DataGateway/*"
        },
        {
            "Effect": "Allow",
            "Action": [
